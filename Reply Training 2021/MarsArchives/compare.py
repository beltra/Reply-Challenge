...
with open(os.path.join(os.getcwd(), "MarsArchives", "archive", "pg30452.txt"), 'r') as f:
    old = f.read()

with open(os.path.join(os.getcwd(), "MarsArchives", "archive", "pg30452 (1).txt"), 'r') as f:
    new = f.read()

with open(os.path.join(os.getcwd(), "MarsArchives", "archive", "pg29771.txt"), 'r') as f:
    new2 = f.read()
...
new3 = """The Travelers and the Plane-Tree.
